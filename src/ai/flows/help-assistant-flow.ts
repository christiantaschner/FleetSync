...
'use server';
/**
 * @fileOverview An AI agent that answers user questions about how to use the FleetSync AI application.
 *
...
const knowledgeBase = `
Feature Documentation for FleetSync AI:
...
const prompt = ai.definePrompt({
    ...
    If the question is unrelated to FleetSync AI, politely state that you can only answer questions about the application.
