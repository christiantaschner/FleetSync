...
import { Briefcase, MapPin, User, Clock, AlertTriangle, CheckCircle, Zap } from 'lucide-react';
...
const JobListItem: React.FC<JobListItemProps> = ({ job, technicians }) => {
  ...
  const getPriorityBadgeVariant = (priority: Job['priority']): "default" | "secondary" | "destructive" | "outline" => {
    ...
    if (priority === 'Medium') return 'default'; // Using primary color for medium
    return 'secondary';
  };
