...
const ChatCard: React.FC<ChatCardProps> = ({ job, technician, appId }) => {
    ...
    const handleSendMessage = async (e: React.FormEvent) => {
        e.preventDefault();
        if ((!newMessage.trim() && !attachment) || !job || !user ) return;
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Communicate with the dispatcher about this job.</CardDescription>
            </CardHeader>
            <CardContent>
                <div className="h-80 flex flex-col border rounded-lg p-2">
                    ...
                    <form onSubmit={handleSendMessage} className="border-t pt-4 mt-2">
                        {attachment && (
