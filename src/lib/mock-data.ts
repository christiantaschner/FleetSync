...
export const mockJobs: Job[] = [
  ...
  },
  {
    ...
    checklistResults: [
      { item: "Confirmed job location and scope with dispatch.", checked: true },
      { item: "Verified all required parts and tools are in the vehicle.", checked: true },
      { item: "Personal Protective Equipment (PPE) is on and in good condition.", checked: true },
      { item: "Work area is clear of hazards and safe to enter.", checked: true },
      { item: "Informed customer of my arrival.", checked: true },
    ],
